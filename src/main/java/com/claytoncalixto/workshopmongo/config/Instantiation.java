package com.claytoncalixto.workshopmongo.config;
...
import com.claytoncalixto.workshopmongo.dto.AuthorDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/03/2018"), "Bom dia!", "Acordei feli hoje!",new AuthorDTO(maria));
